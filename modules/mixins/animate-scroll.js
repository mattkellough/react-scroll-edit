...
var animateScrollX = function animateScrollX(easing, options, timestamp) {
  var data = options.data;
  ...
  data.deltaTop = Math.round(data.targetPositionX - data.startPositionX);
  ...
  if (data.percent < 1) {
    var easedAnimate = animateScrollX.bind(null, easing, options);
    requestAnimationFrameHelper.call(window, easedAnimate);
    return;
  }
...
var scrollToX = function scrollToX(toX, options) {
